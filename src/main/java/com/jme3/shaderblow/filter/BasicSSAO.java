...
public class BasicSSAO extends Filter {
     ...
     * @param bias         the width of the occlusion cone considered by the
     *                     occludee. default 0.1f
     */
    ...
    protected void initFilter(AssetManager manager, RenderManager renderManager, ViewPort vp, int w, int h) {
        ...
        normalPass = new Pass();
        normalPass.init(renderManager.getRenderer(), (int) (screenWidth / downSampleFactor),
                (int) (screenHeight / downSampleFactor), Format.RGBA8, Format.Depth);

        frustumNearFar = new Vector2f();

        float farY = vp.getCamera().getFrustumTop() / vp.getCamera().getFrustumNear()
        ...
        ssaoPass.init(renderManager.getRenderer(), (int) (screenWidth / downSampleFactor),
                (int) (screenHeight / downSampleFactor), Format.RGBA8, Format.Depth, 1, ssaoMat);
